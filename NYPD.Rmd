...
ggplot(racialCrossSec, aes(`Perp Race`, `Victim Race`, fill = log2(n))) + 
  geom_tile() + 
  scale_fill_gradient(low = "grey", high = "chocolate4") +
